...
describe('test suite: renderOrderSummary', () => {
    ...
    it('display the order summary', () => {
        expect(document.querySelectorAll('[class*="js-cart-item-container"]').length).toEqual(2);
    ...
    it('removes a product', () => {
        ...
        expect(document.querySelectorAll('[class*="js-cart-item-container"]').length).toEqual(1);
